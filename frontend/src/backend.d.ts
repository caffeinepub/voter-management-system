...
export interface backendInterface {
    ...
    filterVoters(name: string | null, mobileNo: string | null, voterId: string | null, houseNumber: bigint | null, gender: Gender | null, caste: string | null, area: string | null, taluka: string | null, district: string | null, state: string | null): Promise<Array<Voter>>;
    ...
    updateVoter(voterId: string, updatedVoter: Voter): Promise<void>;
}
