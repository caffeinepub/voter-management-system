...
export class Backend implements backendInterface {
    ...
    async filterVoters(arg0: string | null, arg1: string | null, arg2: string | null, arg3: bigint | null, arg4: Gender | null, arg5: string | null, arg6: string | null, arg7: string | null, arg8: string | null, arg9: string | null): Promise<Array<Voter>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterVoters(to_candid_opt_n8(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n9(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg5), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg6), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg7), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg8), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg9));
    ...
    async updateVoter(arg0: string, arg1: Voter): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateVoter(arg0, await to_candid_Voter_n45(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Task_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Task): Promise<Task> {
...
async function from_candid_Voter_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Voter): Promise<Voter> {
...
function from_candid_opt_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Gender]): Gender | null {
    return value.length === 0 ? null : from_candid_Gender_n30(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_opt_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Voter]): Promise<Voter | null> {
    return value.length === 0 ? null : await from_candid_Voter_n22(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        dob: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.dob)),
        ...
        caste: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.caste)),
        name: value.name,
        srNo: value.srNo,
        mobileNo: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.mobileNo)),
        education: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.education)),
        profession: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.profession)),
        fatherHusbandName: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.fatherHusbandName)),
        office: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.office)),
        educationalDocuments: record_opt_to_undefined(await from_candid_opt_n27(_uploadFile, _downloadFile, value.educationalDocuments)),
        district: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.district)),
        taluka: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.taluka)),
        ...
        politicalIdeology: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.politicalIdeology)),
        comments: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.comments)),
        photo: record_opt_to_undefined(await from_candid_opt_n25(_uploadFile, _downloadFile, value.photo)),
        pincode: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.pincode))
    };
}
async function from_candid_record_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        assignedTo: from_candid_Role_n40(_uploadFile, _downloadFile, value.assignedTo),
        description: value.description,
        deadline: value.deadline,
        attachments: await from_candid_vec_n28(_uploadFile, _downloadFile, value.attachments)
    };
}
...
async function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Voter>): Promise<Array<Voter>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Voter_n22(_uploadFile, _downloadFile, x)));
}
...
async function from_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Task>): Promise<Array<Task>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Task_n36(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Voter_n45(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Voter): Promise<_Voter> {
...
async function to_candid_record_n46(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        houseNumber: value.houseNumber ? candid_some(value.houseNumber) : candid_none(),
        signature: value.signature ? candid_some(await to_candid_ExternalBlob_n14(_uploadFile, _downloadFile, value.signature)) : candid_none(),
        area: value.area ? candid_some(value.area) : candid_none(),
        caste: value.caste ? candid_some(value.caste) : candid_none(),
        name: value.name,
        srNo: value.srNo,
        mobileNo: value.mobileNo ? candid_some(value.mobileNo) : candid_none(),
        ...
        fatherHusbandName: value.fatherHusbandName ? candid_some(value.fatherHusbandName) : candid_none(),
        office: value.office ? candid_some(value.office) : candid_none(),
        educationalDocuments: value.educationalDocuments ? candid_some(await to_candid_vec_n16(_uploadFile, _downloadFile, value.educationalDocuments)) : candid_none(),
        district: value.district ? candid_some(value.district) : candid_none(),
        taluka: value.taluka ? candid_some(value.taluka) : candid_none(),
        state: value.state ? candid_some(value.state) : candid_none(),
        voterId: value.voterId,
        address: value.address ? candid_some(value.address) : candid_none(),
        gender: value.gender ? candid_some(to_candid_Gender_n11(_uploadFile, _downloadFile, value.gender)) : candid_none(),
        politicalIdeology: value.politicalIdeology ? candid_some(value.politicalIdeology) : candid_none(),
